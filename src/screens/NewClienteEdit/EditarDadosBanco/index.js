...
const NameAndDescription = ({ className, data1, setData1, id }) => {
  ...
  const [nib_conta, setNib] = useState();
  const [n_conta, setConta] = useState();
  ...
  function GetAllCliente() {
    return axios
      ...
      .then((response) => {
       ...
       setBanco(response.data.data.Utente.banco)
       setNib(response.data.data.Utente.nib_conta)  
       setConta(response.data.data.Utente.n_conta)        
