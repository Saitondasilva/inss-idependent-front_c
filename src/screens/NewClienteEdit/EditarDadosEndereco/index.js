...
const NameAndDescription = ({ className, data1, setData1, id }) => {
  ...
  const [numero_porta, setPorta] = useState();
  const [ponto_referencia, setReferencia] = useState();
  ...
  function GetAllCliente() {
    return axios
      ...
      .then((response) => {
       ...
       setMorada(response.data.data.Utente.morada)
       setPorta(response.data.data.Utente.numero_porta)  
       setReferencia(response.data.data.Utente.ponto_referencia)        
